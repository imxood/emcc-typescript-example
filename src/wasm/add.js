...
var create_ffmpeg_module = (function() {
  var _scriptDir = import.meta.url;
  
  return (
function(create_ffmpeg_module) {
  create_ffmpeg_module = create_ffmpeg_module || {};
...
var Module = typeof create_ffmpeg_module !== 'undefined' ? create_ffmpeg_module : {};
...
if (Module['locateFile']) {
  ...
  wasmBinaryFile = new URL('add.wasm', import.meta.url).toString();
}
...
Module['onRuntimeInitialized'] = function () {
  ...
  return create_ffmpeg_module.ready
}
);
})();
export default create_ffmpeg_module;